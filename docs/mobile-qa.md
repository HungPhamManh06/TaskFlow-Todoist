...
> Simulated in Playwright (chromium, headless) at 2026-08-13 17:20 — **no physical device**. Software keyboard and real notch safe-area insets (`env(safe-area-inset-*)` = 0 headless) are not covered; everything else is real layout/geometry from the actual app.

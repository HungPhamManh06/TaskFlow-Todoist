...
(function (g) {
  ...
  var ERROR_MAP = {
    vi: {
      ...
      'ai-file-too-large': 'Tệp quá lớn.',
      'ai-file-no-text': 'Không tìm thấy văn bản có thể đọc trong PDF này. Tệp có thể là tài liệu scan hoặc chỉ chứa hình ảnh.',
      'ai-file-pdf-unreadable': 'Không thể đọc PDF này. Tệp có thể bị hỏng hoặc được bảo vệ bằng mật khẩu.',
      'ai-file-type-unsupported': 'Loại tệp không được hỗ trợ.',
      'ai-file-empty': 'Tệp trống.',
      'ai-file-busy': 'Đang xử lý tệp khác. Vui lòng thử lại.',
      'ai-file-processing-failed': 'Xử lý tệp thất bại. Vui lòng thử lại.',
      'network': 'Lỗi mạng.',
    ...
    en: {
      ...
      'ai-file-too-large': 'File is too large.',
      'ai-file-no-text': 'No readable text was found in this PDF. It may be a scanned or image-only document.',
      'ai-file-pdf-unreadable': 'Cannot read this PDF. It may be corrupted or password-protected.',
      'ai-file-type-unsupported': 'Unsupported file type.',
      'ai-file-empty': 'File is empty.',
      'ai-file-busy': 'Another file is being processed. Please try again.',
      'ai-file-processing-failed': 'File processing failed. Please try again.',

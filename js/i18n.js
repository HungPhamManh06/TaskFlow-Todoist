...
(function (root, factory) {
  ...
  vi: {
    ...
    chatPrivacyNote: 'Với câu hỏi về dữ liệu TaskFlow, Trợ lý có thể gửi phần dữ liệu liên quan (Công việc, Dự án, Lịch hoặc Thói quen) đến Gemini để trả lời. Reflection và Mood không được gửi trong giai đoạn này.',
  ...
  en: {
    ...
    chatPrivacyNote: 'For questions about TaskFlow data, the Assistant may send relevant data (Tasks, Projects, Calendar or Habits) to Gemini to answer. Reflections and Mood are not sent in this phase.',

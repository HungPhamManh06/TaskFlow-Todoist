...
const APP_SHELL = [
  ...
  './js/pomo.min.js',
  './js/sync.min.js',
  './js/stats-ui.min.js?v=' + LAZY_V,
  './js/backup.min.js?v=' + LAZY_V,
  ...
  './js/popups.min.js',
  './js/inbox.min.js',
  './js/chat.min.js?v=' + LAZY_V,
  './js/chat-history.min.js?v=' + LAZY_V,
  './js/ai-context.min.js?v=' + LAZY_V,
  './js/ai-context-consent.min.js?v=' + LAZY_V,
  './js/ai-memory.min.js?v=' + LAZY_V,
  './js/ai-adaptation.min.js?v=' + LAZY_V,
  './js/ai-feedback.min.js?v=' + LAZY_V,
  './js/ai-review.min.js?v=' + LAZY_V,
  './js/ai-chat-context.min.js?v=' + LAZY_V,
  './js/chat-provider.min.js?v=' + LAZY_V,
  './js/ai-agent.min.js?v=' + LAZY_V,
  './js/ai-intent.min.js?v=' + LAZY_V,
  './js/ai-explainability.min.js?v=' + LAZY_V,
  './js/ai-plan.min.js?v=' + LAZY_V,
  './js/ai-plan-health.min.js?v=' + LAZY_V,
  './js/ai-plan-watch.min.js?v=' + LAZY_V,
  './js/ai-brief.min.js?v=' + LAZY_V,
  './js/ai-roadmap.min.js?v=' + LAZY_V,
  './js/focus-session.min.js?v=' + LAZY_V,
  './js/effort-calibration.min.js?v=' + LAZY_V,
  './js/goal-tracking.min.js?v=' + LAZY_V,
  './js/ai-agent-runtime.min.js?v=' + LAZY_V,
  './js/ai-tool-contracts.generated.min.js?v=' + LAZY_V,
  './js/ai-tools.min.js?v=' + LAZY_V,
  './js/ai-tool-executor.min.js?v=' + LAZY_V,
  './js/ai-brain-client.min.js?v=' + LAZY_V,
  './js/ai-document-daily-plan.min.js?v=' + LAZY_V,
  './js/search.min.js?v=' + LAZY_V,
  './js/quick-add.min.js?v=' + LAZY_V,
  './js/mood.min.js?v=' + LAZY_V,

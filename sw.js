...
const APP_SHELL = [
  ...
  './js/ai-agent.min.js',
  './js/ai-intent.min.js',
  './js/ai-explainability.min.js',
  './js/ai-plan.min.js',
  './js/ai-plan-health.min.js',
  './js/ai-plan-watch.min.js',
  './js/ai-brief.min.js',
  './js/ai-roadmap.min.js',
  './js/focus-session.min.js',
  './js/effort-calibration.min.js',
  './js/goal-tracking.min.js',
  './js/ai-agent-runtime.min.js',
  './js/ai-tool-contracts.generated.min.js',
  './js/ai-tools.min.js',
  './js/ai-tool-executor.min.js',
  './js/ai-brain-client.min.js',
  './js/ai-document-daily-plan.min.js',
  './js/search.min.js',
  './js/quick-add.min.js',
  './js/mood.min.js',
